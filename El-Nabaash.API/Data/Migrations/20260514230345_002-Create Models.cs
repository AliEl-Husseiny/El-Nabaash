...
namespace El_Nabaash.API.Data.Migrations
{
    /// <inheritdoc />
    public partial class _002CreateModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicNarrative = table.Column<string>(type: "text", nullable: true),
                    ElNabaashNarrative = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogNoteId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatalogNotes_CatalogNotes_CatalogNoteId",
                        column: x => x.CatalogNoteId,
                        principalTable: "CatalogNotes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatalogNotes_CatalogNoteId",
                table: "CatalogNotes",
                column: "CatalogNoteId");
